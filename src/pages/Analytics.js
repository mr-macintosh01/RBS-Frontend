...
function Analytics() {
    ...
    useEffect(() => {
        ...
        axios.post(`http://${process.env.REACT_APP_API_PORT}/getAnalytics`, obj, {headers: {'passwordhash': sessionStorage['passwordhash'], "Access-Control-Allow-Origin": process.env.REACT_APP_API_PORT}})
        .then(res => {
